...
public class CelebritiesActivity extends AppCompatActivity {
    ...
    public void displayData() {
        ...
        guessesText.setText(celebrities.get(i));

        countDownTimer = new CountDownTimer(60000, 1000) {
            @Override
            public void onTick(long l) {
                secondTimerText.setText(String.valueOf(count2));
                count2--;
            }
            ...
            case "Celebrities":
                ...
                gyroscope.setListener(new Gyroscope.Listener() {
                    ...
                    public void onRotation(float rx, float ry, float rz) {
                        if (ry > 5.0f) {
//                            getWindow().getDecorView().setBackgroundColor(R.color.red);
...
//                            getWindow().getDecorView().setBackgroundColor(R.color.green);
